          ...
          <div className="text-center text-white">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  onClick={() => {
                    console.log('Testing UPI QR');
                    onScan('testuser@paytm');
                    onClose();
                  }}
                ...
                <button
                  onClick={() => {
                    console.log('Testing ETH QR');
                    onScan('0x742d35Cc1234567890123456789012345678901234');
                    onClose();
                  }}
                ...
                <button
                  onClick={() => {
                    console.log('Testing FLOW QR');
                    onScan('1234567890abcdef');
                    onClose();
                  }}
                ...
                <button
                  onClick={() => {
                    console.log('Testing MetaMask URI QR');
                    onScan('ethereum:0x6D5EE220E17C9cF3c48b9eaDefC17Bc5449365D9@0x1e');
                    onClose();
                  }}
                ...
                <button
                  onClick={() => {
                    console.log('Testing WalletConnect QR');
                    onScan('wc:00e46b69-d0cc-4b3e-b6a2-cee442f97188@1?bridge=https%3A%2F%2Fbridge.walletconnect.org&key=91303dedf64285cbbaf9120f6e9d160a5c8aa3deb67017a3874cd272323f48ae');
                    onClose();
                  }}
                ...
                <button
                  onClick={() => {
                    ...
                    import('../utils/qrUtils').then(({ testQRAnalysis }) => {
                      testQRAnalysis();
                    });
                  }}
              ...
              <div className="border-t border-white/20 pt-3">
                {!showTextInput ? (
                  <button
                    ...
                    className="w-full bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-full text-sm transition-colors"
                  >
                    Enter QR Code Text Manually
                  </button>
                ) : (
                  <div className="space-y-2">
                    <textarea
                      ...
                      className="w-full bg-white/10 text-white placeholder-white/50 border border-white/20 rounded-lg px-3 py-2 text-sm resize-none"
                      rows={3}
                    />
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        className="flex-1 bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-full text-sm transition-colors"
                      >
                        Cancel
                      </button>
                    </div>
